...
class ClauseBuilder:
    ...
    def text(self, query: str, path: Union[str, List[str]], 
    ...
    def wildcard(self, query: str, path: Union[str, List[str]], 
        ...
        clause = {"wildcard": {
            "query": query,
            "path": path,
            "allowAnalyzedField": allow_analyzed_field
        }}
        if score:
    ...
    def regex(self, query: str, path: Union[str, List[str]], 
              allow_analyzed_field: bool = False,
              score: Optional[float] = None) -> 'ClauseBuilder':
        """
    ...
    def range(self, path: str, gt: Any = None, gte: Any = None,
              lt: Any = None, lte: Any = None,
              score: Optional[float] = None) -> 'ClauseBuilder':
        """
        Add a range clause
    ...
    def autocomplete(self, query: str, path: str, 
                     fuzzy: Optional[Dict[str, Any]] = None,
                     score: Optional[float] = None) -> 'ClauseBuilder':
        """
...
class AtlasSearchBuilder:
    ...
    def text(self, query: str, path: Union[str, List[str]], 
             fuzzy: Optional[Dict[str, Any]] = None, 
             score: Optional[float] = None) -> 'AtlasSearchBuilder':
        """
    ...
    def phrase(self, query: str, path: Union[str, List[str]], 
               slop: int = 0, score: Optional[float] = None) -> 'AtlasSearchBuilder':
        """
    ...
    def autocomplete(self, query: str, path: str, 
                     max_terms: int = 50, fuzzy: Optional[Dict[str, Any]] = None) -> 'AtlasSearchBuilder':
        """
    ...
    def regex(self, query: str, path: Union[str, List[str]], 
              allow_analyzed_field: bool = False) -> 'AtlasSearchBuilder':
        """
    ...
    def range(self, path: str, gt: Any = None, gte: Any = None, 
              lt: Any = None, lte: Any = None) -> 'AtlasSearchBuilder':
        """
    ...
    def use_facet_operator(self, operator: Union[CompoundBuilder, Dict[str, Any], None] = None) -> 'AtlasSearchBuilder':
        """
    ...
    def more_like_this(self, like: Union[Dict[str, Any], List[Dict[str, Any]]]) -> 'AtlasSearchBuilder':
        """
    ...
    def facet(self, name: str, type: str = "string", path: Optional[str] = None, 
              num_buckets: int = 10, boundaries: Optional[List] = None) -> 'AtlasSearchBuilder':
        """
    ...
    def count(self, type: str = "lowerBound", threshold: Optional[int] = None) -> 'AtlasSearchBuilder':
        """
