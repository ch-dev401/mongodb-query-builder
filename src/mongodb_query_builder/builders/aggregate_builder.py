...
class AggregateBuilder:
    ...
    def group(self, by: Union[str, Dict[str, Any], None] = None, 
              **accumulators) -> 'AggregateBuilder':
        """
    ...
    def unwind(self, path: str, preserve_null: bool = False, 
               include_array_index: Optional[str] = None) -> 'AggregateBuilder':
        """
    ...
    def lookup(self, from_collection: str, local_field: str, 
               foreign_field: str, as_field: str) -> 'AggregateBuilder':
        """
    ...
    def lookup_pipeline(self, from_collection: str, let_vars: Dict[str, str],
                       pipeline: List[Dict], as_field: str) -> 'AggregateBuilder':
        """
        ...
        if not all([from_collection, as_field]):
            raise AggregateBuilderError(
                "lookup_pipeline() requires from_collection and as_field"
            )
    ...
    def bucket(self, group_by: str, boundaries: List[Union[int, float, datetime]], 
               default: Any = None, output: Optional[Dict[str, Any]] = None) -> 'AggregateBuilder':
        """
    ...
    def bucket_auto(self, group_by: str, buckets: int, 
                    output: Optional[Dict[str, Any]] = None,
                    granularity: Optional[str] = None) -> 'AggregateBuilder':
        """
    ...
    def graph_lookup(self, from_collection: str, start_with: str, 
                     connect_from_field: str, connect_to_field: str,
                     as_field: str, max_depth: Optional[int] = None,
                     depth_field: Optional[str] = None,
                     restrict_search_with_match: Optional[Dict[str, Any]] = None) -> 'AggregateBuilder':
        """
        ...
        Returns:
            Self for chaining
        """
        if not all([from_collection, start_with, connect_from_field, 
                    connect_to_field, as_field]):
            raise AggregateBuilderError(
    ...
    def union_with(self, collection: str, pipeline: Optional[List[Dict[str, Any]]] = None) -> 'AggregateBuilder':
        """
    ...
    def merge(self, into: Union[str, Dict[str, str]], 
              ...
              when_not_matched: str = "insert") -> 'AggregateBuilder':
        """
